...
<div class="content signed clearfix">
    ...
    <div class="userBlock">
    	...
    	<div class="margin-top boder-top padding-top margin-bottom-lg">
    		<p class="margin-bottom-sm"><strong>&nbsp&nbsp{GLANG.for_admin}</strong></p>
    		<ul class="nv-list-item sm">
    			<li>
    				<a class="fa fa-cog fa-horizon margin-right-sm" href="{NV_BASE_SITEURL}{NV_ADMINDIR}/index.php?{NV_LANG_VARIABLE}={NV_LANG_DATA}" title="{GLANG.admin_page}"><span >&nbsp&nbsp{GLANG.admin_page}</span></a>
    			</li>
    			<!-- BEGIN: is_modadmin -->
    			<li>
    				<a class="fa fa-key fa-horizon margin-right-sm" href="{URL_ADMINMODULE}" title="{GLANG.admin_module_sector} {MODULENAME}"><span>&nbsp&nbsp{GLANG.admin_module_sector} {MODULENAME}</span></a>
    			</li>
    			<!-- END: is_modadmin -->
    			<!-- BEGIN: is_spadadmin -->
    			<li>
    				<a class="fa fa-arrows fa-horizon margin-right-sm" href="{URL_DBLOCK}" title="{LANG_DBLOCK}"><span>&nbsp&nbsp{LANG_DBLOCK}</span></a>
    			</li>
    			<!-- END: is_spadadmin -->
    			<li>
    				<a class="fa fa-user fa-horizon margin-right-sm" href="{URL_AUTHOR}" title="{GLANG.admin_view}"><span>&nbsp&nbsp{GLANG.admin_view}</span></a>
    			</li>
    		</ul>
    	</div>
    	<!-- END: admintoolbar -->
    	<div class="row">
    		<div class="col-xs-16 small">
    			<em class="button btn-sm icon-enter" title="{LANG.current_login}"></em>&nbsp&nbsp{USER.current_login_txt}
    		</div>
