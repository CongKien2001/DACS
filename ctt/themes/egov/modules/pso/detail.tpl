...
<div class="table-responsive">
    <table class="table table-striped table-bordered table-hover">
        <tbody>
		    <tr class="hoatim">
                <td style="width:200px" class="text-right">{LANG.title}</td>
                <td><h3 class="lawh3">{DATA.title}</h3></td>
            </tr>
            <tr class="hoatim">
            ...
            <tr class="hoatim">
                ...
                <td><strong>{DATA.startvalid}</strong></td>
            </tr>
            <!-- END: startvalid -->
            <!-- BEGIN: exptime -->
            <tr class="hoatim">
            ...
            <tr class="hoatim">
                ...
                <td>
                    <!-- BEGIN: link --><a href="{DATA.cat_url}" title="{DATA.cat}"><strong>{DATA.cat}</strong></a><!-- END: link -->
            ...
            <tr class="hoatim">
                ...
                <td>
                    <!-- BEGIN: area_link --><a href="{AREA.url}" title="{AREA.title}"><strong>{AREA.title}</strong></a><br /><!-- END: area_link -->
            ...
            <tr class="hoatim">
                ...
                <td>
                    <!-- BEGIN: link --><a href="{DATA.subject_url}" title="{DATA.subject}"><strong>{DATA.subject}</strong></a><!-- END: link -->
            ...
            <tr class="hoatim">
                ...
                <td>
                    <!-- BEGIN: link --><a href="{DATA.signer_url}" title="{DATA.signer}"><strong>{DATA.signer}</strong></a><!-- END: link -->
            ...
            <!-- END: relatement -->
			<tr>
                <td class="text-right">{LANG.note}</td>
                <td>{DATA.note}</td>
            </tr>
			<tr>
                <td class="text-right">{LANG.introtext}</td>
                <td>{DATA.introtext}</td>
            </tr>
			<tr>
                <td class="text-right">{LANG.delegate}</td>
                <td>{DATA.delegate}</td>
            </tr>
			<tr>
                <td class="text-right">{LANG.execution}</td>
                <td>{DATA.execution}</td>
            </tr>
			<tr>
                <td class="text-right">{LANG.ingredient}</td>
                <td>{DATA.ingredient}</td>
            </tr>
			<tr>
                <td class="text-right">{LANG.leadtime}</td>
                <td>{DATA.leadtime}</td>
            </tr>
			<tr>
                <td class="text-right">{LANG.subjects}</td>
                <td>{DATA.subjects}</td>
            </tr>
			<tr>
                <td class="text-right">{LANG.result}</td>
                <td>{DATA.result}</td>
            </tr>
			<tr>
                <td class="text-right">{LANG.fees}</td>
                <td>{DATA.fees}</td>
            </tr>
			<tr>
                <td class="text-right">{LANG.declarationform}</td>
                <td>{DATA.declarationform}</td>
            </tr>
			<tr>
                <td class="text-right">{LANG.legalbasis}</td>
                <td>{DATA.legalbasis}</td>
            </tr>
			<!-- BEGIN: bodytext -->
			<tr>
                <td class="text-right">{LANG.bodytext}</td>
                <td>{DATA.bodytext}</td>
            </tr>
			<!-- END: bodytext -->
        </tbody>
