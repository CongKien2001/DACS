	...
	<body>
		<div id="wraper">
            <div class="container">
                <div id="logo">
                    <!-- BEGIN: image -->
                    <a title="{SITE_NAME}" href="{NV_BASE_SITEURL}"><img src="{NV_BASE_SITEURL}themes/{ADMIN_THEME}/images/phubinh.vn.png" class="img-responsive" width="{WIDTH}" height="{HEIGHT}" alt="{SITE_NAME}" /></a>
                    <!-- END: image -->
                    <!-- BEGIN: swf -->
                    <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="{WIDTH}" height="{HEIGHT}" >
                        ...
                        <param name="movie" value="{NV_BASE_SITEURL}themes/{ADMIN_THEME}/images/phubinh.vn.png" />
                        ...
                        <!--[if !IE]> <-->
                        <object type="application/x-shockwave-flash" width="{WIDTH}" height="{HEIGHT}" data="{NV_BASE_SITEURL}themes/{ADMIN_THEME}/images/phubinh.vn.png" >
                            <param name="wmode" value="transparent" />
                ...
                <div class="row">
                    <div class="col-xs-24 col-sm-12 col-md-12col-lg-12">
                        <div id="login-content">
                            ...
                            <p class="lostpass{SHOW_LOSTPASS}">
                                ...
                                <a style="float: right" href="{SITEURL}">{GLANG.back} {SITE_NAME}</a>
                            </p>
                        </div>
                    ...
                    <div class="col-xs-24 col-sm-12 col-md-12col-lg-12">
                        <div class="suport-info">
                            <div class="title-support ">Thời gian hỗ trợ khách hàng</div>
                            <div>
                                <b>Từ thứ 2 – 7:</b> từ 07:30 đến 17:00<br>
                                <ul>
                                    <li>Hướng dẫn khách hàng sử dụng và quản trị website</li>
                                    <li>Các công tác tư vấn, hỗ trợ khách hàng hoàn thiện giao diện website</li>
                                    <li>Xử lý các sự cố kỹ thuật</li>
                                </ul>
                            </div>
                            <br>
                            <div>
                                <div>
                                    <b>Thời gian còn lại:</b> Tiếp nhận yêu cầu, xử lý các sự cố kỹ thuật ảnh hưởng đến việc vận hành của website (website truy cập không ổn định, website ngừng hoạt động…)
                                </div>
                                <br>
                                <div class="hotline"><span>Hỗ trợ 24/7: </span> <b class="hotline-phone">0934.741.747</b></div>
                                <div class="anydesk text_right">
                                </div>
                            </div>
                        </div>
                    </div>
