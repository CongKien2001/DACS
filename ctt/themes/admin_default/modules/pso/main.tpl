                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
							...
							<tr>
                                ...
                                <td><textarea class="form-control" rows="5" name="delegate" id="delegate">{DATA.delegate}</textarea></td>
                            </tr>
							<tr>
                                <td style="vertical-align:top">{LANG.execution}</td>
                                <td><textarea class="form-control" rows="5" name="execution" id="execution">{DATA.execution}</textarea></td>
                            </tr>
							<tr>
							...
							<tr>
                                ...
                                <td><textarea class="form-control" rows="5" name="fees" id="fees">{DATA.fees}</textarea></td>
                            </tr>
							<tr>
