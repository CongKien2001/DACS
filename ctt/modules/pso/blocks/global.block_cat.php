...
{
	function nv_block_config_pso_cat( $module, $data_block, $lang_block )
	{
		$html = '';
        $html .= '<tr>';
	...
	function nv_block_config_pso_cat_submit( $module, $lang_block )
	{
		global $nv_Request;
		$return = array();
		$return['error'] = array();
    ...
    function nv_pso_block_cat( $block_config )
    {
...
if( defined( 'NV_SYSTEM' ) )
{
	...
	if( isset( $site_mods[$module] ) )
	{
		...
		$content = nv_pso_block_cat( $block_config );
	}
}