...
if ( ! function_exists( 'nv_pso_block_subject' ) )
{
	function nv_block_config_pso_subject( $module, $data_block, $lang_block )
	{
		$html = '';
        $html .= '<tr>';
	...
	function nv_block_config_pso_subject_submit( $module, $lang_block )
	{
		global $nv_Request;
		$return = array();
		$return['error'] = array();
    ...
    function nv_pso_block_subject( $block_config )
    {
...
{
	$content = nv_pso_block_subject( $block_config );
}